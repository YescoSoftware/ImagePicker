...
ImagePicker.prototype.getPictures = function(success, fail, options) {
	...
	var params = {
		...
		title: options.title ? options.title : 'Select Camera Roll', // the default is the message of the old plugin impl
		message: options.message ? options.message : null, // the old plugin impl didn't have it, so passing null by default
		outputType: options.outputType ? options.outputType : this.OutputType.BASE64_STRING,
